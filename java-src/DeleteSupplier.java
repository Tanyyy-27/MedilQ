...
public class DeleteSupplier extends JFrame implements ActionListener
{
    ...
    DeleteSupplier()
    {
        ...
        b0 = new JButton("Open");
        b0.setBounds(centerX-260,buttonY,100,35);
        jf.add(b0);
        b0.addActionListener(this);

        b1 = new JButton("Delete");
        b1.setBounds(centerX-140,buttonY,110,35);
        jf.add(b1);
        b1.addActionListener(this);

        b2 = new JButton("Clear");
        b2.setBounds(centerX,buttonY,100,35);
        jf.add(b2);
        b2.addActionListener(this);

        b3 = new JButton("All");
        b3.setBounds(centerX+120,buttonY,100,35);
        jf.add(b3);
        b3.addActionListener(this);

        b4 = new JButton("Back");
        b4.setBounds(centerX+240,buttonY,100,35);
        jf.add(b4);
