...
public class UpdateSupplier extends JFrame implements ActionListener
{
    ...
    UpdateSupplier()
    {
        ...
        t1.setToolTipText("Enter supplier id");
        jf.add(t1);
        ...
        t5.setToolTipText("Enter supplier emailid");
        jf.add(t5);

        int buttonY = 360;

        b0 = new JButton("Open");
        b0.setBounds(centerX-260,buttonY,110,35);
        jf.add(b0);
        b0.addActionListener(this);

        b1 = new JButton("Update");
        b1.setBounds(centerX-130,buttonY,110,35);
        jf.add(b1);
        b1.addActionListener(this);

        b2 = new JButton("Clear");
        b2.setBounds(centerX,buttonY,110,35);
        jf.add(b2);
        b2.addActionListener(this);

        b3 = new JButton("All");
        b3.setBounds(centerX+130,buttonY,110,35);
        jf.add(b3);
        b3.addActionListener(this);

        b4 = new JButton("Back");
        b4.setBounds(centerX+260,buttonY,110,35);
        jf.add(b4);
        b4.addActionListener(this);

        scrlPane.setBounds(100,430,width-200,height-520);
        jf.add(scrlPane);
